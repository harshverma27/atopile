...
def _extract_net_name_info(
    ...
    # ElectricPower pre-attaches SUGGESTED "hv"/"lv", and
    # override_net_name adds an EXPECTED one on top. Taking
    # only the first would drop the override.
    # Two SUGGESTED on one node tie on rank, so
    # _determine_base_name breaks it lexicographically.
